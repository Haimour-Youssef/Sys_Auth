          ...
          <div class="row">
            <div class="col-lg-9 col-xl-7 mx-auto">
              <div id="wizard_container">
                ...
                <!-- /top-wizard -->
                <form id="f1" method="POST" action="assets/php/Binscription.php">
                  ...
                  <div id="middle-wizard">
                    <div class="step">
                      ...
                      <div class="mb-3 form-floating">
                        <input type="text" name="fname" id="firstname" class="form-control required" placeholder="Prénom">
                        <label for="firstname">Prénom</label>
                      </div>
                      <div class="mb-3 form-floating">
                        <input type="text" name="lname" id="lastname" class="form-control required" placeholder="Nom">
                      ...
                      <div class="form-floating mb-4">
                        <label for="telephone">Je suis un professionnel de santé</label>
                        <select  name="" id="telephone" class="form-control">
                  ...
                  <div id="bottom-wizard">
                    <button type="button" name="forward" id="inscrit" class="Hola">S'inscrire</button>
                  </div>
                  <!-- /bottom-wizard -->
                </form>
              </div>
